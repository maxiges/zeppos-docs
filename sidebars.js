    ...
    items: [
      {
        ...
        items: [
          '/hmUI/widget/IMG',
          { path: '/hmUI/widget/TEXT', targets: [1] },
          { path: '/hmUI/widget/ARC', targets: [1] },
          { path: '/hmUI/widget/FILL_RECT', targets: [1] },
          { path: '/hmUI/widget/STROKE_RECT', targets: [1] },
          ...
          { path: '/hmUI/widget/CIRCLE', targets: [1] },
          { path: '/hmUI/widget/IMG_POINTER', targets: [1] },
          { path: '/hmUI/widget/BUTTON', targets: [1] },
