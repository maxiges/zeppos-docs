...
| options  | <code>Options</code> | N        | -                     | Other Options                      | 3.0       |

### Options

| Property | Type                | Required | DefaultValue | Description                                                                                                   | API_LEVEL |
| -------- | ------------------- | -------- | ------------ | ------------------------------------------------------------------------------------------------------------- | --------- |
| appId    | <code>number</code> | N        | -            | Mini Program ID, you can open the file in the `/data` directory of the Mini Program with the corresponding ID | 3.0       |
