...
| Property | Type                | Description                                                           | API_LEVEL |
| -------- | ------------------- | --------------------------------------------------------------------- | --------- |
| spo2     | <code>number</code> | Blood oxygen measurement value                                        | 3.0       |
| time     | <code>number</code> | Time of measurement of blood oxygen values, UTC time stamp in seconds | 3.0       |
